...
<html>
    ...
    <body>
        ...
        <div style="margin-bottom: 100px">
            ...
            <h1><a href = "/lab5">Пятая лабораторная</a></h1>
            <h1><a href = "/lab6">Шестая лабораторная</a></h1>
            <h1><a href = "/lab7/index">Седьмая лабораторная</a></h1>
            <h1><a href = "/lab8/">Восьмая лабораторная</a></h1>
             <h1><a href = "/lab9/">Девятая лабораторная</a></h1>
        </div>
